                ...
                <div className="flex flex-col space-y-10">
                    <div className="flex justify-center items-start w-140 h-160">
                        <div className="absolute flex flex-col justify-center items-center w-140 h-80 bg-project/90 border-1 border-white/25 rounded-lg overflow-hidden h-95 p-10 shadow-md shadow-black -top-10">
                            ...
                            />
                            <Link href="https://tailwindcss.com/docs/top-right-bottom-left" className="text-base mt-5">
                                <button className="p-3 px-5 bg-slate-900/95 shadow-md shadow-slate-400/50 rounded-full cursor-pointer"><span className="text-white text-lg font-medium">Watch Code</span></button>
                            </Link>
                        </div>
